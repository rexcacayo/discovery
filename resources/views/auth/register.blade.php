...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>DISCOVERY</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Registrar promotor</p>
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                <input type="password" name="password_confirmation" class="form-control" placeholder="Confirma contraseña">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        ...
        <a href="{{ url('/login') }}" class="text-center">Ya soy promotor</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
